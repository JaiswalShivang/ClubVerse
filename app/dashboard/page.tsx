...
export default function StudentDashboard() {
    ...
    const mockClubs: Club[] = [
      {
        ...
        description:
          "Capture moments, create memories. Join us for photo walks and workshops.",
  ...
  const handleJoinClub = (clubId: string) => {
      ...
      prev.map((club) =>
        club.id === clubId
          ? {
              ...
              userRole: club.isJoined ? undefined : "member",
            }
          : club
      )
    );
    ...
    setMyClubs((prev) => {
      ...
      if (updatedClub && !updatedClub.isJoined) {
        return [
          ...prev,
          { ...updatedClub, isJoined: true, userRole: "member" },
        ];
      }
  ...
  const filteredClubs = clubs.filter((club) => {
    ...
    const matchesCollege =
      selectedCollege === "all" || club.collegeName === selectedCollege;
            ...
            <div className="flex justify-between items-center py-4">
              <div>
                ...
                <p className="text-gray-600">
                  {user.collegeName} • Discover and engage with clubs
                </p>
              </div>
            </div>
          </div>
