...
export default function ClubAdminDashboard() {
    ...
    const mockEvents: ClubEvent[] = [
      {
        ...
        description:
          "Learn advanced photography techniques with professional equipment",
        date: "2024-01-25",
        time: "2:00 PM",
  ...
  const getRoleBadge = (role: ClubMember["role"]) => {
    switch (role) {
      case "president":
        return (
          <Badge className="bg-yellow-100 text-yellow-800">President</Badge>
        );
      case "vice_president":
        return (
          <Badge className="bg-blue-100 text-blue-800">Vice President</Badge>
        );
      case "lead":
            ...
            <div className="flex justify-between items-center py-4">
              <div>
                ...
                <p className="text-gray-600">
                  Photography Club • {user.collegeName}
                </p>
              </div>
            </div>
          </div>
            ...
            <TabsContent value="chat" className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Moderate and manage club communications
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <p className="text-sm text-gray-600 mb-2">
                        <strong>Alice Johnson:</strong> Hey everyone! Don't
                        forget about tomorrow's workshop!
                      </p>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      <p className="text-sm text-gray-600 mb-2">
                        <strong>Bob Smith:</strong> Looking forward to it!
                        Should we bring our own cameras?
                      </p>
                      <div className="flex justify-between items-center text-xs text-gray-500">
